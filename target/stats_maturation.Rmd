...
plot(tmp$PC1, tmp$PC2, axes = FALSE,
     ...
     col =  class_col[class], 
     pch = 16, ylim = c(-12.5, 15), main = "Score plot")
grid()
...
plot(tmp$PC1, tmp$PC2, axes = FALSE, xlab = "PC1", ylab = "PC2",
     col =  col_class[cmps$class], xlim = c(-0.07, 0.07), 
...
plt.cls(cls = "Lyso_PC", clr = "Greens", dcrs = F)

plt.cls(cls = "Lyso_PE", clr = "Greens", dcrs = F)
