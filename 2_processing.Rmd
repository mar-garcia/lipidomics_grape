...
for(i in seq(nrow(ft))){
  ...
  if(s == "tissues" & p == "NEG"){
    ...
    # do not consider tail of 
    ### "PA_16:0_18:2":
#    if(length(unlist(matchWithPpm(690.5068, ft$mzmed[i], ppm = 10))) == 1){
#      if(ft$rtmed[i]/60 > 16.35 & ft$rtmed[i]/60 < 16.5){
#        idx_ms2 <- NULL
#      }}
    ### "DAG_18:1_18:2":
...
#  }else if(s == "maturation" & p == "POS"){
    ...
    ### "PA_16:0_18:2":
#    if(length(unlist(matchWithPpm(690.5068, ft$mzmed[i], ppm = 10))) == 1){
#      if(ft$rtmed[i]/60 > 16.3 & ft$rtmed[i]/60 < 16.45){
#        idx_ms2 <- NULL
#      }}
  }
...
if(nrow(ms2_excl) > 0){
  ...
  if(s == "tissues" & p == "NEG"){
    excl <- c(
      ...
      "PE_15:0_18:1d7 [M-H]-", "PE_16:0_18:1 _II [M-H]-", "PE_16:0_18:3 [M-H]-", 
      "PE_18:1_18:2 [M-H]-", "PE_18:2_18:2 [M-H]-", "PE_18:3_18:2 [M-H]-",
      "PE_20:0_18:2 [M-H]-", "PE_22:0_18:2 [M-H]-", "PE_18:2_23:0 [M-H]-",
    ...
    excl <- c(
      ...
      "PC_16:0_16:1 [M+H]+",
      "PE_15:0_18:1d7 [M+H]+", "PE_16:0_18:1 _I [M+H]+", "PE_16:0_18:1 _II [M+H]+",
      "PE_16:0_18:2 [M+H]+", 
      "PE_18:1_18:2 [M+H]+", "PE_18:2_23:0 [M+H]+", "PE_18:3_18:2 [M+H]+",
      "PE_22:0_18:2 [M+H]+",
      "PG_16:0_16:0 [M+NH4]+",
      "CER_hex_dihydroxy_18:1_26:0 [M+H]+", #???
