...
for(i in which(ft$ms2 > 1 & ft$ms2 < 10)){
  ...
  myf <- function(x){
    ...
    SpectrumSimilarity(x[[1]], x[[2]], print.graphic = FALSE, t = 0.01, b = 10)
  }
  if(length(ms2sub) == 1){
    ft$ms2_sim[i] <- "-"
...
if(nrow(ms2_excl) > 0){
  ...
  if(s == "tissues" & p == "NEG"){
    excl <- c(
      ...
      "mPA_16:0_18:1 [M-H]-", "mPA_16:0_18:2 [M-H]-", "mPA_18:1_18:2 [M-H]-",
      "mPA_18:2_18:3 [M-H]-",
      "dmPA_16:0_18:2 [M-H]-", "dmPA_18:2_18:2 [M-H]-", 
      "PE_18:2_18:2 [M-H]-", 
      "PG_16:0_16:0 [M-H]-", "PG_16:0_18:1 [M-H]-", "PG_16:0_18:2 [M-H]-",
      ...
      "CER_hex_dihydroxy_18:1_24:0 [M-H]-", "CER_hex_hydroxy_34:1 [M-H+HCOOH]-",
    ...
    excl <- c(
      excl, 
      "PA_18:1_18:2 [M-H]-",
      "mPA_16:0_18:2 [M-H]-", "mPA_18:2_18:2 [M-H]-", "mPA_18:2_18:3 [M-H]-",
      "PE_16:0_18:3 [M-H]-", "PE_18:2_18:2 [M-H]-", "PE_18:3_18:2 [M-H]-", "PE_22:0_18:2 [M-H]-",
      "PG_16:0_16:0 [M-H]-","PG_16:0_18:1 [M-H]-",
      "CER_hex_dihydroxy_18:1_22:0 [M-H]-", "CER_hex_dihydroxy_18:1_24:0 [M-H]-")
  } else if(s == "tissues" & p == "POS"){
    excl <- c(
      excl, 
      "PE_16:0_18:2 _I [M+H]+", "PE_18:1_18:2 [M+H]+", "PE_18:2_18:2 [M+H]+",
      "TAG_16:0_16:2_18:3 [M+NH4]+")
