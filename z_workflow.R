...
textellipse(elpos[13,], 0.025, cex = 0.8, lab = "2791")
...
textellipse(elpos[20,], 0.025, cex = 0.8, lab = "516")
textellipse(elpos[21,], 0.025, cex = 0.8, lab = "459")
textrect(elpos[22,], 0.45, 0.015, cex = 0.8, lab = "Annotated features")
textellipse(elpos[23,], 0.025, cex = 0.8, lab = "59")
textellipse(elpos[24,], 0.025, cex = 0.8, lab = "52")
textellipse(elpos[25,], 0.025, cex = 0.8, lab = "48")
textellipse(elpos[26,], 0.025, cex = 0.8, lab = "39")
textrect(elpos[27,], 0.45, 0.015, cex = 0.8, lab = "Unique compounds")
textellipse(elpos[28,], 0.025, cex = 0.8, lab = "40")
textellipse(elpos[29,], 0.025, cex = 0.8, lab = "42")
textellipse(elpos[30,], 0.025, cex = 0.8, lab = "39")
textellipse(elpos[31,], 0.025, cex = 0.8, lab = "33")
textellipse(elpos[32,], 0.025, cex = 0.8, lab = "42")
textellipse(elpos[33,], 0.025, cex = 0.8, lab = "37")
textellipse(elpos[34,], 0.025, cex = 0.8, lab = "45")
