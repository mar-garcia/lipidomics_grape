...
In this document we first do an unsupervised exploratory analysis and later we classify compounds by "tissue specificity" according to their abundances in identified compounds.
