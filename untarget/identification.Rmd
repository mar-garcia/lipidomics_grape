...
for(i in seq(nrow(ids))){
  ...
  if(i.class %in% c("PA", "mPA", "dmPA")) {
    i.ions <- c(
      ...
      #    "[2M-H-CH2]-", "13C[2M-H-CH2]-", "2(13C)[2M-H-CH2]-", "3(13C)[2M-H-CH2]-"
    )
    #  if(i.class == "PA"){
    ...
    i.ions <- c(
      #    "[M+H]+", "13C[M+H]+", "2(13C)[M+H]+", "[2M+H]+", "13C[2M+H]+", "2(13C)[2M+H]+", 
      "[M-H]-"#, "13C[M-H]-", "2(13C)[M-H]-", "3(13C)[M-H]-", "[M-H+HCOONa]-", 
      #    "[2M-H]-", "13C[2M-H]-", "2(13C)[2M-H]-"
    )
    #} else if(i.class == "PG"){
    #  i.ions <- c("[M+NH4]+", "13C[M+NH4]+", "[M-H]-", "13C[M-H]-")
  } else if(i.class == "PI"){
    i.ions <- c(
      #    "[M+H]+", 
    ...
    i.ions <- c(
      #    "2(13C)[M+H]+", "[M+NH4]+", "13C[M+NH4]+", "2(13C)[M+NH4]+", "3(13C)[M+NH4]+", 
      #    "[M+Na]+", "13C[M+Na]+", 
      #    "[M+C2H8N]+", "13C[M+C2H8N]+",
      #    "[2M+NH4]+", "13C[2M+NH4]+", "2(13C)[2M+NH4]+", 
    ...
    i.ions <- c(
      #"[M+H]+",
      "[M-H]-"#, "13C[M-H]-", "[2M-H]-", "[M-H-CO2]-", "[M-H-H2O]-"
    )
...
mydb$class <- factor(mydb$class, levels = c(
  "FFA", "CAR", "CER", "PA", "mPA", "dmPA", "Lyso_PC", "PC", "Lyso_PE", "PE", "PG", "PI", "PS", 
