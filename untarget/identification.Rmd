...
library(CompoundDb)
feat_grape$rtmed[unlist(matchWithPpm(c(636.5562, 663.5205), feat_grape$mzmed, ppm = 5))]/60
my.ft <- feat_grape$X[unlist(matchWithPpm(c(636.5562, 663.5205), feat_grape$mzmed, ppm = 5))][2]
