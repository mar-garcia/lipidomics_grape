...
ms2sub <- filterPrecursorMz(ms2_POS, 772.5851 + 0.005 * c(-1, 1))
ms2sub <- filterRt(ms2sub, 16.85*60 + 10 * c(-1, 1))
ms2sub <- ms2sub[grepl("STDmix", basename(ms2sub@backend@spectraData$dataOrigin))]
#ms2sub <- filterMzValues(ms2sub, 283.7, ppm = 20, keep = FALSE)
#ms2sub <- ms2_POS[containsMz(ms2_POS, 396.2173, tolerance = 0.01)]
#570.5479 - 571.5516
